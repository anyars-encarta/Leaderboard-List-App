...
> This is a Leaderboard List App project to display scores of players. The added scores are saved to the https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/ engagement API. They are also preserved to the localStorage. On
